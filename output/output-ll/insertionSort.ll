; ModuleID = 'insertionSort.cpp'
source_filename = "insertionSort.cpp"
...
%class.InsertionSort = type { i8 }

$_ZN13InsertionSort4sortEPii = comdat any

$_ZN13InsertionSort10printArrayEPii = comdat any
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_insertionSort.cpp, i8* null }]
...
define linkonce_odr dso_local void @_ZN13InsertionSort4sortEPii(%class.InsertionSort* noundef nonnull align 1 dereferenceable(1) %0, i32* noundef %1, i32 noundef %2) #6 comdat align 2 {
...
define linkonce_odr dso_local void @_ZN13InsertionSort10printArrayEPii(i32* noundef %0, i32 noundef %1) #7 comdat align 2 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_insertionSort.cpp() #0 section ".text.startup" {
